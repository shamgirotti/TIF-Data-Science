...
### Selección de Datos: 
Se utilizó un dataset con 180,519 registros y 53 variables (https://www.kaggle.com/datasets/shashwatwork/dataco-smart-supply-chain-for-big-data-analysis?select=DataCoSupplyChainDataset.csv)
...
### Modelado: 
Implementación de un algoritmo de Random Forest Classifier.
